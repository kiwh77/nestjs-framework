...
exports.SQLLogger = exports.Logger = exports.logger = exports.ContextTrace = exports.LoggerLevel = void 0;
...
exports.logger.level = LoggerLevel.DEBUG;
class Logger {
    static trace(...args) {
        exports.logger.trace(Logger.getStackTrace(), ...args);
    }
    static debug(...args) {
        exports.logger.debug(Logger.getStackTrace(), ...args);
    }
    static log(...args) {
        exports.logger.info(Logger.getStackTrace(), ...args);
    }
    static info(...args) {
        exports.logger.info(Logger.getStackTrace(), ...args);
    }
    static warn(...args) {
        exports.logger.warn(Logger.getStackTrace(), ...args);
    }
    static warning(...args) {
        exports.logger.warn(Logger.getStackTrace(), ...args);
    }
    static error(...args) {
        exports.logger.error(Logger.getStackTrace(), ...args);
    }
    static fatal(...args) {
        exports.logger.fatal(Logger.getStackTrace(), ...args);
    }
    static access(...args) {
...
class SQLLogger {
    logQuery(query, parameters) {
        exports.logger.debug(Logger.getStackTrace(), query);
    }
    logQueryError(error, query, parameters) {
        exports.logger.error(Logger.getStackTrace(), query);
    }
    logQuerySlow(time, query, parameters) {
        exports.logger.warn(Logger.getStackTrace(), query);
    }
